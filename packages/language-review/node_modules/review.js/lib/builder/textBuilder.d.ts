...
export declare class TextBuilder extends DefaultBuilder {
    extention: string;
    escape(data: any): string;
    headlinePre(process: BuilderProcess, _name: string, node: HeadlineSyntaxTree): void;
    headlinePost(process: BuilderProcess, _name: string, _node: HeadlineSyntaxTree): void;
    columnHeadlinePre(process: BuilderProcess, node: ColumnHeadlineSyntaxTree): (v: TreeVisitor) => void;
    columnHeadlinePost(process: BuilderProcess, _node: ColumnHeadlineSyntaxTree): void;
    ...
    ulistPost(process: BuilderProcess, _name: string, _node: UlistElementSyntaxTree): void;
    olistPre(process: BuilderProcess, _name: string, node: OlistElementSyntaxTree): void;
    olistPost(process: BuilderProcess, _name: string, _node: OlistElementSyntaxTree): void;
    dlistPre(process: BuilderProcess, _name: string, node: DlistElementSyntaxTree): (v: TreeVisitor) => void;
    dlistPost(process: BuilderProcess, _name: string, _node: DlistElementSyntaxTree): void;
    ...
    inline_href_pre(process: BuilderProcess, _node: InlineElementSyntaxTree): void;
    inline_href_post(process: BuilderProcess, _node: InlineElementSyntaxTree): void;
    inline_href(process: BuilderProcess, node: InlineElementSyntaxTree): boolean;
    block_label(_process: BuilderProcess, _node: BlockElementSyntaxTree): boolean;
    inline_ruby(process: BuilderProcess, node: InlineElementSyntaxTree): (_v: TreeVisitor) => void;
    ...
    inline_kw(process: BuilderProcess, node: InlineElementSyntaxTree): (_v: TreeVisitor) => void;
    ...
    block_noindent(process: BuilderProcess, _node: BlockElementSyntaxTree): boolean;
    ...
    inline_ami_pre(_process: BuilderProcess, _node: InlineElementSyntaxTree): void;
    inline_ami_post(process: BuilderProcess, node: InlineElementSyntaxTree): void;
    inline_bou_pre(_process: BuilderProcess, _node: InlineElementSyntaxTree): void;
